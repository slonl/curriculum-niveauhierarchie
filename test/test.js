	...
	var valid = ajv.addSchema(basisSchema, 'https://opendata.slo.nl/curriculum/schemas/curriculum-basis/context.json')
			.addSchema(schema, 'https://opendata.slo.nl/curriculum/schemas/curriculum-erk/context.json')
            .validate('https://opendata.slo.nl/curriculum/schemas/curriculum-erk/context.json', curriculum.data);
